      ...
      <div className="mt-10 grid grid-cols-1 gap-16 gap-y-10 md:grid-cols-12">
        ...
        <div className=" col-span-1 md:col-span-12">
          <Projects
            ...
            img="/src/assets/images/ib-group-desktop.webp"
        ...
        <div className="col-span-1 pt-0 md:col-span-7 md:pt-16">
          <Projects
            ...
            img="/src/assets/images/memento-desktop.webp"
        ...
        <div className="col-span-1 pt-0 md:col-span-5 md:pt-80">
          <Projects
            ...
            img="/src/assets/images/acc-square.webp"
        ...
        <div className="col-span-1 h-fit pt-0 md:col-span-8 md:pt-20">
          <Projects
            ...
            img="/src/assets/images/godaddy-desktop.webp"
        ...
        <Projects
            ...
            img="/src/assets/images/sunnyside-desktop.webp"
